...
<el-descriptions class="margin-top" title="医生信息查看" :column="1" border style="width:600px;float:left">
        <template slot="extra">
          <el-button type="primary" size="small" @click="drawer = true">选择医生</el-button>
        </template>
...
<el-drawer
  ...
  <div slot="header" class="clearfix">
    ...
    <el-button style="float: right; padding: 3px 0" type="text" @click="select()">选择</el-button><!--这里button加从数据库调信息的方法-->
  </div>
